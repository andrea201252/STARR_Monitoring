...
def main(run_step_05: bool = True,
    ...
    control_pixels, ci_summary, report, fig05, out05 = \
        s05.run_baseline_ci_uncbsl()

    summary["ci90_lower"]  = ci_summary.get("lower_bound")
    summary["ci90_mean"]   = ci_summary.get("mean")
    summary["ci90_upper"]  = ci_summary.get("upper_bound")
