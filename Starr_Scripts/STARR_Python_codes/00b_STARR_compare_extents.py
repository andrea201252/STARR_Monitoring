...
def plot_comparison(metrics_list: list[dict],
    ...
    criteria_keys = ["ratio_3x", "match_cov_90pct",
                     "twin_pass_30pct", "smd_le_010", "ALL_SUFFICIENT"]
    criteria_labels = [
